...
<style>
 ...
 <div class="ln_clmbx flex  justify-between  items-center ">
     <div class="swiper mySwiper"  data-aos="fade-up" data-aos-easing="linear" data-aos-duration="800">
  ...
  <div class="container mx-auto px-4 py-8 md:py-12">
    ...
    <div class="swiper mySwiper" autoplay="true" loop="true" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="800">
      <div class="swiper-wrapper">
        ...
        ?>
          <div class="swiper-slide">
            <div class="border-2 border-blue-500 border-dotted rounded px-4 py-6 booc" style="height:400px;">
                ...
                <div class="flex flex-col md:flex-row gap-4 my-2 items-center">
                  <div class="md:pl-2">
                    <div class="w-20 h-20 md:w-24 md:h-24 rounded-full mx-auto md:mx-0">
                      <img src="<?php echo 'admin/uploads/testimonial/' . $prod_item['profile']; ?>" class="w-full h-full rounded-full object-cover">
                    </div>
                  </div>
