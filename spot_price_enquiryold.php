...
<body>
    ...
    <main class="mt-[70px] md:mt-0">
        ...
        <!-- Page Content -->
        <section class="py-10">
            <form class="flex bg-white rounded shadow-2xl shadow-gray-500 border md:w-fit container mx-auto"
                ...
                <div class="w-full flex flex-col divide-y">
                    <div class="flex gap-5 items-center w-full p-5 p-5 text-white"
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <p style="width: 450px; height: 130px;">For enquiry, complaint, deactivate or disable
                    ...
                    <div class="flex flex-col gap-5 p-5">
                        ...
                        <div class="relative z-0 w-full">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder=" " required value="<?php if ($name) {
                                    echo $name;
                                } ?>" />
