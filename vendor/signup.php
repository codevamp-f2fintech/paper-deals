...
<body>
			...
			<div class="container mb-6 cont-iner">
				<div class="sgnupbx">
					<div class="sell sgndata" style="background:linear-gradient(259.26deg, #006efa, #07cdbe 84.05%)">
						<div class="media">
							<img src="undraw_online_stats_0g94.svg" class="mx-auto  mt-20" alt="">
						</div>
						<div class=" head">
    ...
    <!-- Your OTP input and submit elements here -->
     <input type="text" id="otpInput" name="otp" class="form-control rounded border-2 px-4 pt-5 pb-3 block w-full" maxlength="4" placeholder="Enter OTP"/>
    <div style="margin:12px;"><span id="timer">60&nbsp;&nbsp; </span><span> &nbsp;&nbsp;OTP till valid</span></div>
...
"></p>
 ...
 sendsms();
    ...
    $('#resetOtp').click(function() {
        ...
        $('#timer').text('60'); // Reset the timer display
        sendsms();
    });
        });
    </script>
