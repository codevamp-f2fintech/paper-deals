...
if ($_SESSION['role'] == 1) {
    $res = mysqli_query($conn, "SELECT * FROM pd_deals WHERE status = 1 AND deal_status = 1");
} else if ($_SESSION['role'] == 2) {
    $res = mysqli_query($conn, "SELECT * FROM pd_deals WHERE deal_status = 1 AND deal_id = '" . $_SESSION['id'] . "'");
} ?>
