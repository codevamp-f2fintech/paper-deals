                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php  
                                            $formattedDateTime = date("H:i:s d-m-Y", strtotime($prod_item['created_at']));
                                        ...
                                        <td>
                                            <a href="view-support.php?prod_id=<?php echo $prod_item['id']; ?>" style=" #width:95px;  padding:2% 4%;border-radius:6px;height:10px;">View</a>
                                        </td>
                                    </tr>
