    ...
    <section class="content mt-4">
        <div class="col-md-12">
            ...
            <div class="card-header">
                <h4 style="font-size:28px;color:#1C2434;margin:2% 0 1% 0.6%;">
                    Business History
                </h4>
            </div>
            <div class="card">
                                        ...
                                        <td style="text-align:center;   ">
                                            <div class=" dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style=" border:none; ">
                                                    <li>
                                                        <a href="current-edit-deal.php?role=<?= $_SESSION['role']; ?>&prod_id=<?php echo $prod_item['id']; ?> " class="dropdown-item">
                                                            <?php if ($role == 1) {
                                                                echo 'Edit';
                                                            } else {
                                                                echo 'View';
            ...
            ?>
            <tr>
                <td colspan=" 13" class="dataTables_empty">No Record found
                </td>
            </tr>
        <?php
                            }
