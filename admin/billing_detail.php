...
<div class="content-wrapper">
    ...
    if (isset($_GET['prod_id'])) {
        ...
        $query = "select * from deals where id='$product_id'";
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Deal ID</label>
                                                    <input type="text" value="000<?php echo $prodItem['deal_id']; ?>" class="form-control" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group" style="margin-top: 7px;">
                                                    <label></label>
                                                    <button type="submit" name="billing_save" class="btn btn-primary btn-block">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['prod_id'])) {
                                                $product_id = $_GET['prod_id'];
                                                $query = "SELECT * From billing_admn where deal_id='$product_id'";
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="download.php?prod_id=<?php echo $prod_item['id']; ?>">Download
                                                                    Invoice</a>
                                                            </td>
                                                        </tr>
                                                    <?php
