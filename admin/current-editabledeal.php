                                                    ...
                                                    <?php if ($role == 1 || $role == 2 || $role == 3) { ?>
                                                        <?php if ($prod_item['status'] == '1') { ?>
                                                            <form action="code.php" method="post">
                                                                <input type="hidden" name="return_url" value="current-deals.php">
                                                                <input type="hidden" name="deal_id" value="<?= $prod_item['id']; ?>">
                                                                <li>
                                                                    <button type="submit" name="deactive_deal" class="dropdown-item">Deactive</button>
                                                                </li>
                                                            </form>
                                                        <?php } else { ?>
                                                            <form action="code.php" method="post">
                                                                <input type="hidden" name="return_url" value="current-deals.php">
                                                                <input type="hidden" name="deal_id" value="<?= $prod_item['id']; ?>">
                                                                <button type="submit" name="active_deal" class="btn ">Active</button>
                                                            </form>
                                                        <?php } ?>
                                                        <li>
