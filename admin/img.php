...
if ($_SESSION['role'] == 1) {
    $res = mysqli_query($conn, "SELECT * FROM deals WHERE status=1");
} else if ($_SESSION['role'] == 2) {

    $res = mysqli_query($conn, "SELECT * FROM deals WHERE seller_id = '" . $_SESSION['id'] . "'");
...
//     '#htmlContent': function (element, renderer) {
//         return true;
//     }
// };
