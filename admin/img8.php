...
if (isset($_GET['prod_id'])) {
    ...
    if ($_SESSION['role'] == 1) {
        ...
        FROM pd_deals AS de
        LEFT JOIN pd_clearance AS i ON i.deal_id = de.id AND i.product = de.id
        LEFT JOIN pd_transportation AS u ON u.deal_id = de.id 
        LEFT JOIN pd_payment AS c ON c.deal_id = de.id
        WHERE de.id = $id");
