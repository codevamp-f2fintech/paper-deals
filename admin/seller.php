...
<div class="content-wrapper">
    <div class="" style="margin:3% 1%">
        <h4 style="font-weight:500;font-size:28px;color:#1C2434;margin:2% 0 1% 0.6%;">
            Seller
            <a href=" add-user.php?role=2" class="btn btn-primary float-right">Add Seller </a>
        </h4>
    </div>
                    ...
                    <table class="table table-bordered" id="dataTable">
                        <thead>
                            <tr style="text-align:center;">
                                ...
                                <th style="border:none;border-bottom:1px solid #dbdbdb;">Seller Name</th>

                                <th style="border:none;border-bottom:1px solid #dbdbdb;">Seller Email</th>
                                <th style="border:none;border-bottom:1px solid #dbdbdb;">Seller Phone</th>
                                ...
                                foreach ($query_run as $prod_item) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;border-bottom:1px solid #dbdbdb;text-align:center  ">
                                            ...
                                            //else {
                                                //echo '<a style="width:100px ;border:1px solid #BC3803;padding:4px; height:20px;font-size:13px; color:#BC3803;background-color:#FFEFCA; border-radius:6px;" fffefca>Pending <i class="fa-regular fa-clock" style="color:#BC3803"></i></a>';
                                            //} 
                                            ?>
                                        </td>
                                                <td style="border:none; border-bottom:1px solid #dbdbdb; text-align:center  ">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                                    ...
                                                    <li>
                                                        <a class=" dropdown-item"
                                                            href="view-details.php?role=<?php echo $_SESSION['role']; ?>&user_type=2&prod_id=<?= $prod_item['id']; ?>">
                                                            Edit
                                                        </a>
                                                    </li>
                                                    ...
                                                    <?php if ($role == 1) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <li>
                                                            <a href="change_password.php?role=2&prod_id=<?= $prod_item['id']; ?>"
