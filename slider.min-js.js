                ...
                (t.prototype.init = function () {
                  ...
                  this._items.length &&
                    ...
                    (this._items.forEach(function (e) {
                      ...
                      e.triggerEl.addEventListener("hover", i),
                        (e.clickHandler = i);
                    }),
                    (this._initialized = !0));
                }),
                (t.prototype.destroy = function () {
                  this._items.length &&
                    ...
                    (this._items.forEach(function (t) {
                      t.triggerEl.removeEventListener("hover", t.clickHandler),
        ...
        33: function (t, e, i) {
                ...
                (t.prototype.init = function () {
                  ...
                  this._items.length &&
                    ...
                    this._indicators.map(function (e, i) {
                      e.el.addEventListener("hover", function () {
                        t.slideTo(i);
                      });
                    }),
                    (this._initialized = !0));
          ...
          function c() {
            document.querySelectorAll("[data-carousel]").forEach(function (t) {
              ...
              d &&
                d.addEventListener("hover", function () {
                  c.next();
                }),
                l &&
                  l.addEventListener("hover", function () {
                    c.prev();
                  });
            });
          }
                ...
                .forEach(function (t) {
                  ...
                  if (document.getElementById(e)) {
                    ...
                    if (i) {
                      ...
                      t.addEventListener("hover", n),
                        i.addEventListenerInstance(t, "hover", n);
                    } else
                      console.error(
              ...
              return (
                ...
                (t.prototype._getTriggerEvents = function () {
                  switch (this._options.triggerType) {
                    case "hover":
                      return {
                        showEvents: ["mouseenter", "hover"],
                        hideEvents: ["mouseleave"],
                      };
                    case "hover":
                    default:
                      return { showEvents: ["hover"], hideEvents: [] };
                    case "none":
                      return { showEvents: [], hideEvents: [] };
                  }
                }),
                ...
                (t.prototype.init = function () {
                  ...
                  this._items.length &&
                    ...
                    this._items.map(function (e) {
                      e.triggerEl.addEventListener("hover", function (i) {
