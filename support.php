    ...
    <main>
        ...
        <section class="bg-[url('assets/herobg.jpg')] bg-cover lg:bg-fixed bg-no-repeat bg-bottom relative w-full h-fit">
            <div class="flex flex-col gap-2 items-center justify-center w-full bg-[#090909c4] px-4 py-16 md:py-24">
                <h1 class="text-2xl md:text-4xl font-bold text-white">Paper Deals Support</h1>
        ...
        <section class="my-20 mx-auto  min-h-[60vh] px-4 lg:px-0" id="contaact">
            <form action="support_submit.php" method="POST" onsubmit="return validateForm()">
                <div class="w-full " id="main_cont">
                    <div class="content  p-5 bg-gradient-to-br from-blue-600 to-teal-400 text-white w-full md:w-[50%]  " id="contactt">
                        <div class="sm:w-[80px]  md:w-[400px] mx-auto md:my-20 sm:my-2">
                            <img src="Support.svg" id="immag" alt="">
                        </div>
                    </div>

                    <div class="flex flex-col  min-h-[60vh]  p-5 w-full md:w-[50%] shadow-2xl  border overflow-hidden" id="con-sec">
                        <!-- <i class="bi bi-person-fill-add text-5xl "></i> -->
                        <div class="flex flex-col gap-1 contacta">
                            <h1 class=" text-3xl"> <i class="fa-solid fa-phone text-2xl text-[#027ff0]"></i> Support</h1>
                        ...
                        ?>
                            ...
                            <!--    <hr>-->
                            <!--    <p class="mt-2">We have recieved your enquiry, soon we will contact you.</p>-->
  ...
  <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex items-center justify-center h-8 w-8  " data-dismiss-target="#alert-3" aria-label="Close">
    ...
    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            ...
            <select name="subject" id="subject1" class="rounded border-2 px-4 pt-5 pb-3 block w-full text-gray-900 bg-transparent border-0 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" required>
                <option value="">--Select--</option>
                <option>Enquiry about Services</option>
                <option>Complaint</option>
                <option>Other</option>
            </select>
            <label for="subject" class="peer-focus:font-medium absolute duration-300 transform -translate-y-5 scale-75 left-5 peer-focus:left-5 top-5 -z-10 origin-[0] peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5">Subject</label>
        </div>
                            <div class="relative z-0 w-full mb-2">
                                <input type="text" name="name" id="name" class="rounded border-2 px-4 pt-5 pb-3 block w-full text-gray-900 bg-transparent border-0 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-2">
                                <input type="number" name="phone" id="phone" class="rounded border-2 px-4 pt-5 pb-3 block w-full text-gray-900 bg-transparent border-0 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" />
                                <label title="Phone Number" for="phone" class="peer-focus:font-medium absolute duration-300 transform -translate-y-5 scale-75 left-5 peer-focus:left-5 top-5 -z-10 origin-[0]  peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5">Enter
                            ...
                            <div class="relative z-0 w-full mb-2">
                                ...
                                <label title="Email" for="floating_email" class="peer-focus:font-medium absolute duration-300 transform -translate-y-5 scale-75 left-5 peer-focus:left-5 top-5 -z-10 origin-[0]  peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5">Enter
                                    Your Email</label>

                            </div>

                            <div class="relative z-0 w-full mb-2">
                                <textarea type="text" name="message" id="message1" class="rounded resize-none border-2 px-4 pt-5 pb-3 block w-full text-gray-900 bg-transparent border-0 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "></textarea>
                                <label title="Message" class="peer-focus:font-medium absolute duration-300 transform -translate-y-5 scale-75 left-5 peer-focus:left-5 top-5 -z-10 origin-[0]  peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5">Message</label>
                            </div>

                        </div>

                        <div class="text-center flex ml-[5px] mt-4  mb-4">
                            <button class="py-2 w-full md:w-full rounded text-white border-[#027ff0] border duration-700" style="background:linear-gradient(45deg, #1078FF 0%, #00DFDF 70%);" type="submit" name="support_submit">Submit</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    var selectElement = document.getElementById("subject1").value;
