            ...
            <div class="container mx-auto px-4 py-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    if ($_POST) {
                        ...
                        $query = "SELECT users.*,organization.user_id,organization.city, consultant_pic.prof_pic, consultant_pic.description, consultant_pic.years_of_experience, consultant_pic.mills_supported
                    FROM users 
                    LEFT JOIN consultant_pic ON users.id = consultant_pic.user_id
                    LEFT JOIN organization ON users.id = organization.user_id
                    WHERE user_type = 5 AND active_status = 1 AND (users.name LIKE '%$searchterm%' OR organization.city LIKE '%$searchterm%') 
                    ...
                    FROM users 
                    LEFT JOIN consultant_pic ON users.id = consultant_pic.user_id 
                    WHERE user_type = 5 AND active_status = 1 
                    ORDER BY users.id DESC;
                    ";
                    }
                    ...
                    ?>
                            ...
                            <div class="bg-white rounded-lg shadow-md overflow-hidden" style="border:2px dotted;">
                                <img src="<?php if ($prod_item['prof_pic']) { ?><?= $prod_item['prof_pic']; ?> <?php } else { ?>https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/logo+(2).jpg <?php } ?>" alt="<?php echo $prod_item['name']; ?>" class="w-full h-64 object-cover" style="width: 150px;height: 150px;
    border-radius: 100%;
    margin: 30px auto;
    object-fit:contain;
">
              ...
              :136px;">
                                        ...
                                        <!-- <h6 ><strong>Email :</strong> &nbsp;&nbsp;<?php //echo $prod_item['email_address']; 
                                                                                        ?></h6> -->
                                        ...
                                        <h6><strong>Description :</strong> &nbsp;&nbsp;<?php echo substr($prod_item['description'], 0, 64); ?></h6>
                                    </div>
