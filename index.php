        ...
        <div class="slider-container">
            <div class="slider-wrapper" id="slider">
                ...
                <div class="slider-slide">
                    <img class="slider-img" src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/pd-banner.jpg" alt="Banner 1">
                </div>
                <div class="slider-slide">
                    <img class="slider-img" src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/pd-banner.jpg" alt="Banner 2">
                </div>
                <div class="slider-slide">
                    <img class="slider-img" src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/pd-banner.jpg" alt="Banner 3">
                </div>
            </div>
            <!-- Fixed Overlay -->
        ...
        <div class="container">
            ...
            <div class="abt_sctn ">
                ...
                <div class="flex gap-2 items-center sell " data-aos="fade-up" data-aos-duration="1500">
                    <div class=" icon">
                        <img src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/icons8-inquiry-96.png" alt="">
                ...
                <div class="flex gap-2 items-center sell " data-aos="fade-up" data-aos-duration="1500">
                    <div class="icon">
                        <img src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/icons8-trust-96 (1).png" alt="">
                    </div>
                    <div class="dtab">
                ...
                <div class="flex gap-2 items-center sell" data-aos="fade-up" data-aos-duration="1500">
                    <div class="icon">
                        <img src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/icons8-coins-96.png" alt="">
                    </div>
                    <div class="dtab">
                ...
                <div class="flex gap-2 items-center sell" data-aos="fade-up" data-aos-duration="1500">
                    <div class="icon">
                        <img src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/icons8-organization-96 (4).png" alt="">
                    </div>
                    <div class="dtab">
...
<style>
 @media (min-width: 300px) and (max-width: 768px) {
    ...
    <!-- Latest News -->
     ...
     <div class="swiper mySwiper" autoplay="true" loop="true" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="800"  style="width:95%;margin:auto;">
      <div class="swiper-wrapper">
            <!--<div class="ln_clmbx grid grid-cols-1 md:grid-cols-3 gap-6">-->
                ...
                ?>
                 <div class="swiper-slide" style="background:white; padding:12px;border-radius:8px;">
                          <div class="sellbx" data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
                                <div class="h-full flex items-start" style="height:400px;">
                                
                                    <div class="grow ">
                                        <a class="inline-flex items-center" style=";height:250px;width:100% !important;">
                                            <img alt="paperdeals" src="<?= $prod_item["image"]; ?>"
                                                class="rounded-md flex-shrink-0  w-full "style="height:100%;width:100%;object-fit:cover;">
...
<a href="read-news.php?id=<?php echo $prod_item['id']; ?>" style="margin-left:60px;"><span class="underline hover:text-blue-500">Read
                                        News</span></a>
                                    </div>
...
<section class="tstmlsection">
  <div class="container mx-auto px-4 py-8 md:py-12">
    <div class="head text-center mb-8">
      ...
      <p class="text-gray-600">One of the best marketplaces for the Paper Industry</p>
    </div>

    <div class="swiper mySwiper" autoplay="true" loop="true" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="800">
      <div class="swiper-wrapper">
        ...
        ?>
          <div class="swiper-slide">
            <div class="border-2 border-blue-500 border-dotted rounded px-4 py-6 booc" style="height:450px;">
              <div class="h-full text-center">
                <div class="flex flex-col md:flex-row gap-4 my-2 items-center">
                  <div class="md:pl-2">
                    <div class="w-20 h-20 md:w-24 md:h-24 rounded-full mx-auto md:mx-0">
                      <img src="<?php echo $prod_item['profile']; ?>" class="w-full h-full rounded-full object-cover">
                    </div>
                  </div>
                  <div class="flex flex-col items-center md:items-start md:justify-left">
                ...
                <p class="leading-relaxed testim">
                   <?= substr($prod_item['para'],0,4000); ?>
                </p>
              </div>
            </div>
          </div>
  ...
  document.addEventListener('DOMContentLoaded', function () {
        ...
        <div class="container">
            ...
            <div class="hwwbx">
                <div class="hwwrpt " data-aos="flip-left" data-aos-duration="1500" data-aos-easing="ease-out-cubic">
                    <div class="medai">
                        <img src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/icons8-seller-96.png" alt="">

                    </div>
                    <div class="mb-3 hwwda">
                        <h3>Seller</h3>
                        <p>One of the best marketplace for Paper Industry Importer, Wholeseller, Distributor</p>
                    </div>
                    <div>
                    <a href="faqs.php" class="py-1 px-6" style="background:linear-gradient(45deg, #1078FF 0%, #00DFDF 70%);position: absolute;
    top: 82%;
    left: 36%;border-radius: 0.375rem;">FAQ
                                            </a></div>
                </div>
                <div class="hwwrpt " data-aos="flip-left" data-aos-duration="1500" data-aos-easing="ease-out-cubic">
                    <div class="medai"> <img src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/icons8-platform-96.png" alt=""></div>
                    <div class="hwwda">
                        <h3>Platform</h3>
                        <p>One of the best marketplace for Paper Industry</p>
                    </div>
                ...
                <div class="hwwrpt" data-aos="flip-right" data-aos-duration="1500" data-aos-easing="ease-out-cubic">
                    <div class="medai"> <img src="https://paperdeals-doc-bucket.s3.ap-south-1.amazonaws.com/uploads/icons8-buyer-96.png" alt=""></div>
                    <div class="mb-3 hwwda ">
                        <h3>Buyer</h3>
                        <p>One of the best marketplace for Paper Industry Printing offset, Corrugated Box Converter, Tissue Converter, Retailer</p>
                    </div>
                    <div>
                    <a href="faqs.php" class="py-1 px-6" style="background:linear-gradient(45deg, #1078FF 0%, #00DFDF 70%);position: absolute;
    top: 82%;
    left: 36%;border-radius: 0.375rem;">FAQ</a></div>
                </div>
    ...
    <div class="slider">
      ...
      while ($row = mysqli_fetch_array($query_run)) { ?>
            <div class="slide">
                <img class="logo" style="width:100px;object-fit: contain;" src="<?= $row['logo_picture']; ?>">
            </div>
             <?php } ?>
