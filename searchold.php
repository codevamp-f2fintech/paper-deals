        ...
        <section class="srch_sectn">
            ...
            <div class="container">
                ...
                <div class="big-button">
                    <div role="button" class="WhyChooseUs__chooseBuyerBtn--V_l0B <?= $class1; ?> WhyChooseUs__active--YOzBf" id="defaultOpen" onclick="openCity(event, 'buyer')" tabindex="0">
                        Buyer
                    </div>
                            ...
                            <div class="flex flex-col buy-box">
                                <div class="flex flex-col md:flex-row md:items-center rounded border gap-7 p-5 sell your-element h-[240px;] buy-box-1">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        $Vip = "SELECT * FROM `subscription` WHERE user_id='$user_id' and type='Vip'";
                                        $Vipresult = mysqli_query($conn, $Vip);
                                        $Vipresultdata = mysqli_fetch_assoc($Vipresult);
                                        // print_r($Vipresultdata['status']);
                                        ...
                                        <div class="grid grid-cols-7 md:grid-cols-7 md:gap-8 buyer-button">
                                            ...
                                            Now</a> -->
                                            <a href="view_profle.php?role=3&prod_id=<?php echo $prod_item['id']; ?>" class="py-1 px-3 text-white focus:bg-black hover:bg-black" style="width:108px; background:linear-gradient(45deg, #1078FF 0%, #00DFDF 70%);">View
                                                Profile</a>
                                        </div>
                                    </div>
               ...
               // echo $query;
                ...
                ?>
                            ...
                            <div class="flex flex-col">
                                <div class="flex flex-col md:flex-row md:items-center rounded border gap-5 p-5 sell your-element h-[240px]">
                                    <img src="<?php if ($row['image_banner']) { ?>admin/<?= $row['image_banner']; ?> <?php } else { ?>logo.jpg <?php } ?>" alt="alt" class="p-1 border" style="height
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="grid grid-cols-3 md:grid-cols-3 gap-4 md:gap-5">
                                            ...
                                            <div>
                                                <h5 class="font-semibold">Area</h5>
                                                <p>
                                                    <?= $row['city'] . ", " . $row['district'] . " " . $row['pincode']; ?>
                                        ...
                                        <div class="grid grid-cols-7 md:grid-cols-7 md:gap-8">
                                            <!-- <a href="enquiry.php?role=3&prod_id=<?php echo $row['seller_id']; ?>"
                                            class="py-1 px-3 bg-[#86776f] text-white focus:bg-black hover:bg-black">Enquiry
                                            Now</a> -->
                                            <a href="view_profle.php?role=2&prod_id=<?php echo $row['seller_id']; ?>" class="p-2 text-white" style="width:108px; background:linear-gradient(45deg, #1078FF 0%, #00DFDF 70%);">View
                                                Profile</a>
                                        </div>
                            ...
                            ?>
                                    <div class="flex flex-col buy-box">
                                        ...
                                        :200px;width:250px;object-fit:contain;">
                                            ...
                                            class="py-1 px-3 bg-[#86776f] text-white focus:bg-black hover:bg-black">Enquiry
                                            Now</a> -->
                                                    <a href="view_profle.php?role=2&prod_id=<?php echo $prod_item['id']; ?>" class="p-2 text-white" style="width:108px; background:linear-gradient(45deg, #1078FF 0%, #00DFDF 70%);">View
                                                        Profile</a>
                                                </div>
